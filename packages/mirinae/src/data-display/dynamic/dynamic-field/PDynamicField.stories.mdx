...
- disable_copy
  ...
  - true : Hide copy icon
- link_highlighting
  - false (default): Do not highlight the link
  - true : Highlight the link
- link_action_icon
    - 'internal-link' (default): Show internal link icon
    - 'external-link' : Show external link icon
    - 'none' : Hide link icon
    - `link_action_icon` receives props of [Link component](https://storybook.developer.spaceone.dev/?path=/docs/inputs-link--basic-link#action-icon) as it is.
    ...
    <Story name="Text Type">
        {{
            ...
            <div>
                ...
                <br/><br/>
                <p-dynamic-field type="text" :options="{link: 'https://https://cloudforet.io'}" data="Text type with link"></p-dynamic-field>
                <br/><br/>
                <p-dynamic-field type="text" :options="{link: 'https://https://cloudforet.io', link_highlighting: true}" data="Text type with higtlighting link"></p-dynamic-field>
                <br/><br/>
                ...
                <br/><br/>
                <p class="font-bold my-4 text-lg"> with link_action_icon </p>
                <p-dynamic-field type="text" :options="{link: 'https://https://cloudforet.io'}" data="Text type with action_icon(default: internal-link)"></p-dynamic-field>
                <br/><br/>
                <p-dynamic-field type="text" :options="{link: 'https://https://cloudforet.io', link_action_icon: 'external-link'}" data="external-link"></p-dynamic-field>
                <br/><br/>
                <p-dynamic-field type="text" :options="{link: 'https://https://cloudforet.io', link_action_icon: 'none'}" data="none"></p-dynamic-field>
                <br/><br/>
    ...
    <Story name="Datetime Type">
        {{
            ...
            <div>
                ...
                <p-dynamic-field type="datetime" :options="{link: 'https://github.com/cloudforet-io', source_type: 'iso8601', display_format: 'YY.MM.DD hh:mm:ss'}" :data="new Date().toISOString()"></p-dynamic-field>
                <br/><br/>
